...
<head>
	...
	<title>KOSYUK||KOS CAKRANEGARA</title>
	<!-- css style -->
...
<hr class="horizontal">
	<h5>
		<div class="poinatas">
			<i class="fa fa-map-marker" aria-hidden="true"><a href="Daftarmenu.php#cakra" > Cakranegara</a> 
			<i class="fa fa-caret-right" aria-hidden="true"><a href="#"> Kos Cakranegara</a>
				</i>
			</i>
		</div>
	</h5>
...
<div class="barisfoto">
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos kekalik jaya/tampakdepan.jpg" alt="Gerbang Depan" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos kekalik jaya/tv-kulkas-meja-kamar.jpg" alt="Fasilitas" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos kekalik jaya/kamar mandi.jpg" alt="Kamar Mandi" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos kekalik jaya/kkkk.jpg" alt="Kamar Tidur" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos kekalik jaya/Desain-Kamar-Kost-Dapur-Mini.jpg" alt="Ruang Tengah" onclick="myFunction(this);">
        </div>
</div>
<!-- Grid isi -->
<div class="container-grid">
    <div class="preview satu">
        ...
        <div class="kotak-tiga">
            <div class="isi">
                    ...
                    <span class="ket"><i class="fas fa-expand-arrows-alt icon">&nbsp;</i>4x5</span>
            </div>
        </div>
        <br>
        ...
        <br>
            ...
            <div class="kotak-enam">
                <div class="isi">
                        ...
                        <span class="ket"><i class="fas fa-map-marker-alt"></i>Jl. Pejanggik, Cakranegara Bar., Kec. Cakranegara, Kota Mataram, Nusa Tenggara Bar. 83239</span>
                        <span class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.0978075629573!2d116.12066501413892!3d-8.586594393828499!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcdbf58271f7f2f%3A0xc1748512ea2b914c!2sCakranegara!5e0!3m2!1sid!2sid!4v1589251503174!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></span>
                </div>
            </div>
        </span>
    <div class="lanjut">
    ...
    <div class="preview dua">
       <div class="card">
            ...
            <div class="card-satu">
                    <b><span class="kat">Stok Kamar : 2</span></b>
            </div>
             <div class="card-dua">
