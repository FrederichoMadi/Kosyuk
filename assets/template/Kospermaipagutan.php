...
<head>
	...
	<title>KOSYUK||KOS PAGUTAN PERMAI</title>
	<!-- css style -->
...
<hr class="horizontal">
	<h5>
		<div class="poinatas">
			...
			<i class="fa fa-caret-right" aria-hidden="true"><a href="#"> Kos Pagutan Permai</a>
				</i>
			</i>
		</div>
	</h5>
...
<div class="barisfoto">
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos permai pagutan/kos6.jpg" alt="Kamar Tidur" onclick="myFunction(this);">
  </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos permai pagutan/kos4.jpg" alt="Halaman Depan" onclick="myFunction(this);">
  </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos permai pagutan/kos1.jpg" alt="Isi Dalam" onclick="myFunction(this);">
  </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos permai pagutan/kos2.jpg" alt="Fasilitas" onclick="myFunction(this);">
  </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos permai pagutan/kos 5.jpg" alt="Pintu Depan" onclick="myFunction(this);">
  </div>
</div>
<br><br>
    ...
    <div class="preview satu">
        ...
        <div class="kotak-tiga">
            <div class="isi">
                    ...
                    <span class="ket"><i class="fas fa-expand-arrows-alt icon">&nbsp;</i>4x4</span>
            </div>
        </div>
        <br>
        ...
        <br>
            ...
            <div class="kotak-enam">
                <div class="isi">
                        ...
                        <span class="ket"><i class="fas fa-map-marker-alt"></i>Jl. Danau Maninjau I/15 Pagutan Barat, Mataram, NTB</span>
                        <span class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.8946768848327!2d116.1064869141641!3d-8.606110089789958!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcdbf6b24dfb057%3A0x85a29c88fd3a42!2sJl.%20Danau%20Maninjau%20I%2C%20Pagutan%20Bar.%2C%20Kec.%20Mataram%2C%20Kota%20Mataram%2C%20Nusa%20Tenggara%20Bar.%2083117!5e0!3m2!1sen!2sid!4v1588512377919!5m2!1sen!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></span>
                </div>
            </div>
        </span>
    <div class="lanjut">
       ...
       <div class="card">
            ...
            <div class="card-satu">
             ...
             <div class="card-dua">
                    ...
                    <span class="ket harga">Rp 500.000</span>
            </div>
            <div class="card-tiga">
