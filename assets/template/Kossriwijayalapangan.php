...
<head>
	...
	<title>KOSYUK||KOS SRIWIJAYA LAPANGAN</title>
	<!-- css style -->
...
<hr class="horizontal">
	<h5>
		<div class="poinatas">
			<i class="fa fa-map-marker" aria-hidden="true"><a href="Daftarmenu.php#mataram" > Mataram</a> 
			<i class="fa fa-caret-right" aria-hidden="true"><a href="#"> Kos Sriwijaya Lapangan</a>
				</i>
			</i>
		</div>
	</h5>
...
<div class="barisfoto">
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos monjok/halaman.jpg" alt="Halaman Depan" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos monjok/unnamed.jpg" alt="Fasilitas" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos monjok/kamar_mandi.jpg" alt="Kamar Mandi" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos monjok/kos-harian-cowok-cewek-jember.jpg" alt="Kamar Tidur" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos monjok/dapur.jpg" alt="Dapur" onclick="myFunction(this);">
        </div>
</div>
<!-- Grid isi -->
<div class="container-grid">
        ...
        <br>
            ...
            <div class="kotak-enam">
                <div class="isi">
                        ...
                        <span class="ket"><i class="fas fa-map-marker-alt"></i>Jl. Cilinaya No.7, Cilinaya, Kec. Cakranegara, Kota Mataram, Nusa Tenggara Bar. 83239</span>
                        <span class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.08664688809!2d116.11759181413892!3d-8.587667793827759!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcdbf58c6eec8a1%3A0x5939781e7ffe400d!2sMataram%20Mall!5e0!3m2!1sid!2sid!4v1589251777806!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></span>
                </div>
            </div>
        </span>
    <div class="lanjut">
    ...
    <div class="preview dua">
       <div class="card">
            ...
            <div class="card-satu">
                    <b><span class="kat">Stok Kamar : 5</span></b>
            </div>
             <div class="card-dua">
                    <span class="title">Harga Kos</span><br>
                    <span class="ket">Perbulan</span>&nbsp;
                    <span class="ket harga">Rp 450.000</span>
            </div>
            <div class="card-tiga">
