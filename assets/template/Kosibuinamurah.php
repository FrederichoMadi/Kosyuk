...
<head>
	...
	<title>KOSYUK||KOS IBU INA MURAH</title>
	<!-- css style -->
...
<hr class="horizontal">
	<h5>
		<div class="poinatas">
			<i class="fa fa-map-marker" aria-hidden="true"><a href="Daftarmenu.php#perum" > Perum</a> 
			<i class="fa fa-caret-right" aria-hidden="true"><a href="#"> Kost Ibu Ina Murah</a>
				</i>
			</i>
		</div>
	</h5>
