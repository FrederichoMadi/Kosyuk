...
<head>
	...
	<title>KOSYUK||KOS TIMURAN</title>
	<!-- css style -->
...
<hr class="horizontal">
	<h5>
		<div class="poinatas">
			<i class="fa fa-map-marker" aria-hidden="true"><a href="Daftarmenu.php#monjok" > Monjok</a> 
			<i class="fa fa-caret-right" aria-hidden="true"><a href="#"> Kos Timuran</a>
				</i>
			</i>
		</div>
	</h5>
...
<div class="barisfoto">
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos republik perum indah/tampakdepan.jpg" alt="Kamar Tidur" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos republik perum indah/mesincuci.jpg" alt="Fasilitas" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos republik perum indah/kamarmandi.jpg" alt="Kamar Mandi" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos republik perum indah/tangga.jpg" alt="Teras" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos republik perum indah/halaman.jpg" alt="Halaman Depan" onclick="myFunction(this);">
        </div>
</div>
<!-- Grid isi -->
<div class="container-grid">
    <div class="preview satu">
        ...
        <div class="kotak-tiga">
            <div class="isi">
                    ...
                    <span class="ket"><i class="fas fa-expand-arrows-alt icon">&nbsp;</i>5x5</span>
            </div>
        </div>
        <br>
        ...
        <br>
            ...
            <div class="kotak-enam">
                <div class="isi">
                        ...
                        <span class="ket"><i class="fas fa-map-marker-alt"></i>Jl. Terusan Bung Hatta, Monjok, Kec. Selaparang, Kota Mataram, Nusa Tenggara Bar. 83122</span>
                        <span class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.2410389183433!2d116.11644321413877!3d-8.572806993838126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcdc17f8e86e07b%3A0xc044cd2c10c4c3e9!2sMonjok%20Kebon%20Jaya%20Timur!5e0!3m2!1sid!2sid!4v1589253041847!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></span>
                </div>
            </div>
        </span>
    <div class="lanjut">
    ...
    <div class="preview dua">
       <div class="card">
            ...
            <div class="card-satu">
                    <b><span class="kat">Stok Kamar : 1</span></b>
            </div>
             <div class="card-dua">
