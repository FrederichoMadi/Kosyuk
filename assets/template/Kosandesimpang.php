...
<head>
	...
	<title>KOSYUK||KOS JAYA NARMADA</title>
	<!-- css style -->
...
<hr class="horizontal">
	<h5>
		<div class="poinatas">
			<i class="fa fa-map-marker" aria-hidden="true"><a href="Daftarmenu.php#ampenan" > Ampenan</a> 
			<i class="fa fa-caret-right" aria-hidden="true"><a href="#"> Kos Ande Simpang</a>
				</i>
			</i>
		</div>
	</h5>
...
<div class="barisfoto">
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos jaya narmada/Gawangan.jpg" alt="Gerbang Depan" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos jaya narmada/kos-alifah-nyaman.jpg" alt="Fasilitas" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos jaya narmada/kamarmandi.jpg" alt="Kamar Mandi" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos jaya narmada/kos2an.jpg" alt="Halaman Depan" onclick="myFunction(this);">
        </div>
  <div class="kolomfoto">
    <img class="image" src="img/products/Kos jaya narmada/kos-ekslusif-fasilita.jpg" alt="Kamar Tidur" onclick="myFunction(this);">
        </div>
</div>
<!-- Grid isi -->
<div class="container-grid">
    <div class="preview satu">
        <div class="kotak-satu">
            <b><span class="kat">Putri & Putra</span></b>
        </div>
        <br><br><br>
        <div class="kotak-dua">
            <div class="isi">
        ...
        <div class="kotak-tiga">
            <div class="isi">
                    ...
                    <span class="ket"><i class="fas fa-expand-arrows-alt icon">&nbsp;</i>4x3</span>
            </div>
        </div>
        <br>
        ...
        <br>
            <div class="kotak-lima">
                <div class="isi">
                        <p>Kos memiliki lokasi yang asri dan indah, dekat dengan pusat perbelanjaan, serta lingkungan sekitar yang nyaman. </p>
                </div>
            </div>
            ...
            <div class="kotak-enam">
                <div class="isi">
                        ...
                        <span class="ket"><i class="fas fa-map-marker-alt"></i>Jalan Adi Sucipto No. 20, Pejeruk, Ampenan, Ampenan Utara, Kec. Mataram, Kota Mataram, Nusa Tenggara Bar. 83511</span>
                        <span class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.311075347056!2d116.08760771413873!3d-8.566057293842805!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcdc0f4e05e12bf%3A0x7985a8b12f197574!2sBandini%20Koffie!5e0!3m2!1sid!2sid!4v1589252217555!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></span>
                </div>
            </div>
        </span>
    <div class="lanjut">
    ...
    <div class="preview dua">
       <div class="card">
            ...
            <div class="card-satu">
                    <b><span class="kat">Stok Kamar : 3</span></b>
            </div>
             <div class="card-dua">
                    <span class="title">Harga Kos</span><br>
                    <span class="ket">Perbulan</span>&nbsp;
                    <span class="ket harga">Rp 400.000</span>
            </div>
            <div class="card-tiga">
