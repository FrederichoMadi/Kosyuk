 ...
 <table class="table table-bordered" id="example1">
 	...
 	<tbody>
 		...
 		<tr>
 			...
 			<td><?php echo $kos->nama_wilayah ?></td>
 			<td><?php echo number_format($kos->harga,'0',',','.') ?></td>
 			<td><?php echo $kos->stok ?></td>
 			<td>

 				<a href="<?php echo base_url('admin/kos/gambar/'.$kos->id_kos) ?>" class= "btn btn-success btn-xs">
				<i class="fa fa-image"></i>Gambar(<?php echo $kos->total_gambar ?>)</a>

			 	<a href="<?php echo base_url('admin/kos/edit/'.$kos->id_kos) ?>" class= "btn btn-warning btn-xs">
