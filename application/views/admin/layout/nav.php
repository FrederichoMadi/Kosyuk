  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-sitemap"></i> <span>KOS</span>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('admin/wilayah') ?>"><i class="fa fa-tags"></i> Wilayah Kos</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('admin/konfigurasi/icon') ?>"><i class="fa fa-circle-o"></i> Konfigurasi Icon</a></li>
          </ul>
        </li>
