<div class="container">
	<div class="row">
		...
		<div class="col-9">
			...
			// form open
			echo form_open_multipart(base_url('dasbor_penyedia/gambar/'.$kos->id_kos),' class="form-horizontal"');
			 ?>
			...
			<div class="form-group form-group-lg">
			  <label class="col-sm-4 control-label">Unggah Gambar</label>
			  <div class="col-md-4">
			 ...
			 <table class="table table-bordered" id="example1">
			 	...
			 	<tbody>
			 		...
			 		<tr>
			 			...
			 			<td>
						 	<a href="<?php echo base_url('dasbor_penyedia/delete_gambar/'.$kos->id_kos.'/'.$gambar->id_gambar) ?>" class= "btn btn-danger btn-xs" onclick="return confitm('Yakin Ingin Menghapus Gambar Ini?')"><i class="fa fa-trash-o"></i>hapus</a>
			 			</td>
			 		</tr>
			 		<?php $no++; ?>
			 	<?php } ?>
